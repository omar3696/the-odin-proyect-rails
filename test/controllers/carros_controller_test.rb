...
class CarrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create carro" do
    assert_difference("Carro.count") do
      post carros_url, params: { carro: { año: @carro.año, hecho: @carro.hecho, modelo: @carro.modelo } }
    end
  ...
  test "should update carro" do
    patch carro_url(@carro), params: { carro: { año: @carro.año, hecho: @carro.hecho, modelo: @carro.modelo } }
